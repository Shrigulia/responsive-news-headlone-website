const serachResult = () =>{
    ...
    let resultAdd = result.split(" ").join("");
    var today = new Date();
    ...
    today =yyyy + "-" + mm + "-" + dd-1; 
    console.log(today);
    fetch(`https://newsapi.org/v2/everything?q=${resultAdd}&from=${today}&to=${today}&sortBy=popularity&apiKey=cb01e4482103425fa0dd16ffb7f5c746`)
    .then(res=>res.json())
    .then((res)=>{
